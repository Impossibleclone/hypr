...
local tusic = "urxvt -e /home/impossibleclone/go/bin/tusic"
...
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd(tusic))
hl.bind(mainMod .. " + Escape", hl.dsp.exec_cmd("killall Hyprland"))
...
hl.bind(mainMod .. " + X", hl.dsp.window.fullscreen_state({ internal = -1, client = 2 }))
hl.bind("PRINT", hl.dsp.exec_cmd("hyprshot -m output -o ~/pics/ss"))
hl.bind("ALT + PRINT", hl.dsp.exec_cmd("hyprshot -m window -o ~/pics/ss"))
hl.bind(mainMod .. " + SHIFT + C", hl.dsp.exec_cmd("hyprshot -m region -o ~/pics/ss"))
hl.bind(mainMod .. " + P", hl.dsp.exec_cmd("hyprpicker -a"))
hl.bind(mainMod .. " + SHIFT + K",
    hl.dsp.exec_cmd(
        "kitty +kitten panel --edge=background --detach -o background_opacity=0 -o window_padding_width=2 cava"))
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("walzec"))
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd("swicht"))
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd("~/scrpts/stw"))
...
hl.bind("XF86AudioRaiseVolume",
    hl.dsp.exec_cmd(
        "wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%+ && wpctl get-volume @DEFAULT_AUDIO_SINK@ | awk '{print int($2 * 100)}' > /tmp/wobpipe"),
    { locked = true, repeating = true })
hl.bind("XF86AudioLowerVolume",
    hl.dsp.exec_cmd(
        "wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%- && wpctl get-volume @DEFAULT_AUDIO_SINK@ | awk '{print int($2 * 100)}' > /tmp/wobpipe"),
    { locked = true, repeating = true })
hl.bind("XF86AudioMute", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle"),
    { locked = true, repeating = true })
hl.bind("XF86AudioMicMute", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle"),
    { locked = true, repeating = true })
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("brightnessctl s 1%+ && pkill -RTMIN+10 waybar"),
    { locked = true, repeating = true })
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("echo $(( $(brightnessctl get) / 4 )) > /tmp/wobpipe"),
    { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("brightnessctl s 1%- && pkill -RTMIN+10 waybar"),
    { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("echo $(( $(brightnessctl get) / 4 )) > /tmp/wobpipe"),
    { locked = true, repeating = true })
